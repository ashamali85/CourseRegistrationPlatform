...
const en = {
  ...
  schedule: {
    ...
    modeSingle: 'Individual days',
    rangeHintFirst: 'Click the first day of the range.',
    rangeHintSecond: 'Now click the last day — everything between is selected.',
    singleHint: 'Click any day to add or remove it.',
    rangeReplaceNote: 'Picking a new period replaces the current one. Switch to individual days to add scattered dates.',
...
const ar: Dictionary = {
  ...
  schedule: {
    ...
    modeRange: 'فترة متصلة',
    modeSingle: 'أيام منفردة',
    rangeHintFirst: 'اضغط على أول يوم في الفترة.',
    rangeHintSecond: 'الآن اضغط على آخر يوم — سيتم اختيار كل الأيام بينهما.',
    singleHint: 'اضغط على أي يوم لإضافته أو إزالته.',
    rangeReplaceNote: 'اختيار فترة جديدة يستبدل الفترة الحالية. انتقل إلى "أيام منفردة" لإضافة أيام متفرقة.',
