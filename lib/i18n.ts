...
const en = {
  ...
  images: {
    title: 'Course images',
    hint: 'The first image is the thumbnail shown in the course list. The rest appear as a slider on the course page.',
    upload: 'Upload',
...
const ar: Dictionary = {
  ...
  images: {
    title: 'صور الدورة',
    hint: 'الصورة الأولى هي الصورة المصغّرة التي تظهر في قائمة الدورات. أما البقية فتظهر كشريط صور في صفحة الدورة.',
    upload: 'رفع',
