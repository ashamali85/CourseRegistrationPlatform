...
const en = {
  ...
  schedule: {
    ...
    confirmSaveDays: 'Save these days to the schedule?',
    confirmClearDays: 'Clear the selected days? Days with confirmed bookings are kept. Nothing is saved until you press Save days.',
    confirmCopyForward: 'Copy this session to every later day of the course?',
    confirmResize: 'Change this session to {hours} hour(s)?',
  ...
  admin: {
    ...
    confirmCreateCourse: 'Create this course?',
    confirmSaveCourse: 'Save these changes?',
  ...
  images: {
    title: 'Course images',
    thumbnailTitle: 'Cover image',
    thumbnailHint: 'Shown on the course card in the list. One per course.',
    addThumbnail: 'Add cover image',
    replaceThumbnail: 'Replace cover',
    galleryTitle: 'Gallery',
    galleryHint: 'Shown as a slider on the course page, after the cover.',
    addImage: 'Add image',
    dropHint: 'Click or drag a file · JPG, PNG, WEBP · up to 4 MB',
    upload: 'Upload',
    uploaded: 'Image uploaded.',
    deleted: 'Image removed.',
    thumbnail: 'Thumbnail',
    makeThumbnail: 'Make thumbnail',
    thumbnailSet: 'Thumbnail updated.',
    confirmDelete: 'Remove this image?',
    chooseFile: 'Choose an image first.',
    tooLarge: 'Images must be under 4 MB.',
    badType: 'Only JPG, PNG and WEBP images are accepted.',
    tooMany: 'A course can have up to 8 images. Remove one to add another.',
    uploadFailed: 'The upload did not complete. Try again.',
    notConfigured: 'Image storage is not set up yet. Add a Vercel Blob store and BLOB_READ_WRITE_TOKEN to enable uploads.',
...
const ar: Dictionary = {
  ...
  schedule: {
    ...
    confirmSaveDays: 'هل تريد حفظ هذه الأيام في الجدول؟',
    confirmClearDays: 'هل تريد مسح الأيام المختارة؟ الأيام التي عليها حجوزات مؤكدة سيتم الإبقاء عليها. لن يُحفظ أي شيء حتى تضغط على "حفظ الأيام".',
    confirmCopyForward: 'هل تريد نسخ هذه الجلسة إلى كل الأيام التالية من الدورة؟',
    confirmResize: 'هل تريد تغيير مدة هذه الجلسة إلى {hours} ساعة؟',
  ...
  admin: {
    ...
    confirmCreateCourse: 'هل تريد إنشاء هذه الدورة؟',
    confirmSaveCourse: 'هل تريد حفظ هذه التغييرات؟',
  ...
  images: {
    title: 'صور الدورة',
    thumbnailTitle: 'صورة الغلاف',
    thumbnailHint: 'تظهر على بطاقة الدورة في القائمة. صورة واحدة لكل دورة.',
    addThumbnail: 'إضافة صورة الغلاف',
    replaceThumbnail: 'استبدال الغلاف',
    galleryTitle: 'معرض الصور',
    galleryHint: 'تظهر كشريط صور في صفحة الدورة بعد الغلاف.',
    addImage: 'إضافة صورة',
    dropHint: 'اضغط أو اسحب ملفًا · JPG أو PNG أو WEBP · حتى 4 ميجابايت',
    upload: 'رفع',
    uploaded: 'تم رفع الصورة.',
    deleted: 'تمت إزالة الصورة.',
    thumbnail: 'الصورة المصغّرة',
    makeThumbnail: 'اجعلها الصورة المصغّرة',
    thumbnailSet: 'تم تحديث الصورة المصغّرة.',
    confirmDelete: 'هل تريد إزالة هذه الصورة؟',
    chooseFile: 'اختر صورة أولًا.',
    tooLarge: 'يجب أن يكون حجم الصورة أقل من 4 ميجابايت.',
    badType: 'الصيغ المقبولة هي JPG وPNG وWEBP فقط.',
    tooMany: 'يمكن للدورة أن تحتوي على 8 صور كحد أقصى. أزل صورة لإضافة أخرى.',
    uploadFailed: 'لم يكتمل الرفع. حاول مرة أخرى.',
    notConfigured: 'لم يتم إعداد تخزين الصور بعد. أضف Vercel Blob ومتغيّر BLOB_READ_WRITE_TOKEN لتفعيل الرفع.',
